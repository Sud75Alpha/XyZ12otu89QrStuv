...
# Boucle
PRICE_REFRESH_SEC = 5    # push prix vers dashboard toutes les 5s
SIGNAL_SCAN_SEC   = 60   # analyse H1/M15/M5 toutes les 60s
LOOP_INTERVAL_SEC = 5    # intervalle boucle principale
